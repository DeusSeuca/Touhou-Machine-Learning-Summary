...
public static class CardListExtension
{
    ...
    public static List<Card> At(this List<Card> cardList, GameEnum.Orientation orientation)
    {
        switch (orientation)
        {
    ...
    public static List<Card> InRogin(this List<Card> cardList, params RegionTypes[] regions)
    {
        ...
        ////return cardList.Where(card => card.belong == belong).ToList();
        //List<SingleRowInfo> targetRows;
        //if (regions.Contains(RegionTypes.battle))
        //{
        //    targetRows = cardList.Where(card =>
        //     card == RegionTypes.Water ||
        //     card.region == RegionTypes.Fire ||
        //     card.region == RegionTypes.Wind ||
        //     card.region == RegionTypes.Soil
        //    ).ToList();
        //}
        ...
        //else
        //{
        //    targetRows = cardList.Where(row => regions.Contains(row.region)).ToList();
        //}
        return Info.AgainstInfo.AllRows.InRogin(regions).SelectMany(x => x.ThisRowCards).Intersect(cardList).ToList();
    }
    ...
    public static List<Card> morePoint(this List<Card> cardList, int point) => cardList.Where(card => card.CardPoint > point).ToList();
...
public static class RegionExtension
{
    ...
    public static List<SingleRowInfo> At(this List<SingleRowInfo> rows, GameEnum.Orientation orientation)
    {
        ...
        //{
        //    case GameEnum.Orientation.Up:
        //        return rows.Where(row => row.orientation==  Orientation.Up).ToList();
        //    case GameEnum.Orientation.Down:
        //        return rows.Where(row => row.orientation == Orientation.Down).ToList();
        //    case GameEnum.Orientation.My:
        //        return AgainstInfo.IsMyTurn ? rows.At(Orientation.Down) : rows.At(Orientation.Up);
        //    case GameEnum.Orientation.Op:
        //        return AgainstInfo.IsMyTurn ? rows.At(Orientation.Up) : rows.At(Orientation.Down);
        //}
