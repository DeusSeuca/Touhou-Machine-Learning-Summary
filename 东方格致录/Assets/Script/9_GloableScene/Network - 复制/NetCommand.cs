...
namespace Command
{
    ...
    namespace Network
    {
        public static class NetCommand_n
        {
            ...
            {
                client.SendMessge("Regist", new NetInfoModel.GeneralCommand<string>(name, password));
                return client.SendReceiveMessge("Regist", "RegistResult");
            }
