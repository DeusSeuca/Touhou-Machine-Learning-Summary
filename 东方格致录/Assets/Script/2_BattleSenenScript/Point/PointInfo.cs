...
namespace Info
{
    public static class PointInfo
    {
        ...
        public static int TotalUpPoint => AgainstInfo.AllCardList.InRogin(Orientation.Up, RegionTypes.Battle).Sum(card=>card.point);
        public static int TotalDownPoint => AgainstInfo.AllCardList.InRogin(Orientation.Down, RegionTypes.Battle).Sum(card => card.point);
